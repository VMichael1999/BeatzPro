    ...
    return PremiumBackdrop(
      child: Padding(
        padding: isBottomNavActive
            ...
            : EdgeInsets.only(left: 15.0, right: 15, top: topPadding),
        child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    return PremiumBackdrop(
      child: Padding(
        padding: isBottomNavActive
            ? const EdgeInsets.only(left: 15, right: 15)
            : EdgeInsets.only(top: topPadding, left: 15, right: 15),
        child: Column(
          children: [
            Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return PremiumBackdrop(
      child: Padding(
        padding: isBottomNavActive
            ? const EdgeInsets.only(left: 15, right: 15)
            : EdgeInsets.only(left: 15, right: 15, top: topPadding),
        child: Column(
          children: [
            isBottomNavActive
                ? const SizedBox(
            ...
            Obx(
              () => SortWidget(
                ...
                isSearchFeatureRequired: true,
                itemCountTitle:
                    "${cntrller.libraryArtists.length} ${"items".tr}",
                onSort: (type, ascending) {
